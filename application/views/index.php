<?php include('frontend_layout/header.php')?>
    <section class="bg-home" style="background: url('https://www.warwicksu.com/pageassets/venues-events/events/_DSC3538.jpg?thumbnail=true&height=450&width=1100&resize_type=CropToFit') center center;background-size: cover;">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="title-heading text-center text-white">
                                ...
                                <h1 class="heading font-weight-bold mb-4">The Easiest Way To Find Events Near You</h1>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-md-6">
                                                <div class="registration-form-box">
                                                    ...
                                                    <input type="text" id="exampleInputName1" class="form-control rounded registration-input-box" placeholder="Event Keyword">
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-6">
                                                <div class="registration-form-box">
                                                    ...
                                                    <select id="select-country" class="demo-default">
                                                        ...
                                                        <option value="ISLB">Islamabad</option>
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="section-title text-center mb-4 pb-2">
                        <h4 class="title title-line pb-5">Categories</h4>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-9 text-center mt-4 pt-2">
                    <ul class="nav nav-pills nav nav-pills bg-white rounded nav-justified flex-column flex-sm-row" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link rounded active" id="recent-job-tab" data-toggle="pill" href="#recent-job" role="tab" aria-controls="recent-job" aria-selected="true">Recent Events</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link rounded" id="featured-job-tab" data-toggle="pill" href="#featured-job" role="tab" aria-controls="featured-job" aria-selected="false">Featured Events</a>
                        </li>
                     <!--    <li class="nav-item">
    ...
    <section class="section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="section-title text-center mb-4 pb-2">
                        <h4 class="title title-line pb-5">Our Successful Events</h4>
                        <p class="text-muted para-desc mx-auto mb-1">Post a job to tell us about your project. We'll quickly match you with the right freelancers.</p>
                    </div>
                </div>
            </div>
...
<!--     <section class="section">
    ...
    <?php include('frontend_layout/footer.php')?>